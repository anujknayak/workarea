...
burnInPeriod = 30; % in terms of number of snapshots
numSnapShots = 50;
...
for iterLoop = 1:numIters % loop for all iterations
    ...
    [W, psiVec_t, classLabelList, numClasses] = enron_email_nw_get_adjacency_mat();
    ...
    if blockEnableVec(1) == 1
        ...
        % compute error
        errAprioriMat = psiEst_tApriori-sigmoid_fun(yVecApriori);
...
figure(1);hist(mseAprioriVec, 10);
